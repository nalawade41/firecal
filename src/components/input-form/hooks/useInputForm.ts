...
import type { InputFormProps, UseInputFormReturn } from "../types/InputForm.types"

export function useInputForm({ initialInputs, onCalculate }: InputFormProps): UseInputFormReturn {
