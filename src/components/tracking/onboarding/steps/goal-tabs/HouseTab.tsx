    ...
    <div className="space-y-4">
      ...
      {inflatedTarget > 0 && (
        <AlertPanel
          ...
          title={`House Down Payment — in ${house.yearsRemaining} years`}
        >
